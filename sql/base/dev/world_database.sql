...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Access Requirements';
...
) ENGINE=MyISAM AUTO_INCREMENT=999822 DEFAULT CHARSET=utf8 COMMENT='Creature System';
...
/*Table structure for table `creature_addon_copy` */
...
/*Table structure for table `creature_addon_qsdsqd` */
...
/*Table structure for table `creature_area` */
...
/*Table structure for table `creature_copy` */
...
CREATE TABLE `creature_copy` (
  ...
  KEY `idx_map` (`map`) USING BTREE,
  KEY `idx_id` (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=303341 DEFAULT CHARSET=utf8 COMMENT='Creature System';
...
/*Table structure for table `creature_formations_copy` */
...
/*Table structure for table `creature_new` */
...
CREATE TABLE `creature_new` (
  ...
  KEY `idx_map` (`map`) USING BTREE,
  KEY `idx_id` (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=998118 DEFAULT CHARSET=utf8 COMMENT='Creature System';
...
/*Table structure for table `creature_rp` */
...
CREATE TABLE `creature_template` (
  ...
  `unitflags2` int(11) DEFAULT NULL,
  PRIMARY KEY (`entry`),
...
CREATE TABLE `creature_transport` (
  ...
  UNIQUE KEY `entry` (`transport_entry`,`guid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Table structure for table `creature_transport_copy` */
...
/*Table structure for table `creatureold` */
...
CREATE TABLE `creatureold` (
  ...
  KEY `idx_map` (`map`) USING BTREE,
  KEY `idx_id` (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=997600 DEFAULT CHARSET=utf8 COMMENT='Creature System';
...
CREATE TABLE `custom_texts` (
  ...
  `comment` text,
  PRIMARY KEY (`entry`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Custom Texts';
...
/*Table structure for table `event_northhold_watch` */
...
CREATE TABLE `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=54367 DEFAULT CHARSET=utf8 COMMENT='Tele Command';
...
CREATE TABLE `gameobject` (
  ...
  PRIMARY KEY (`guid`)
) ENGINE=MyISAM AUTO_INCREMENT=1530503 DEFAULT CHARSET=utf8 COMMENT='Gameobject System';
...
/*Table structure for table `gameobject_rp` */
...
/*Table structure for table `maxsettings_rp` */

DROP TABLE IF EXISTS `maxsettings_rp`;

CREATE TABLE `maxsettings_rp` (
  `type` int(11) DEFAULT NULL,
  `maxsetting` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `outdoorpvp_template` (
  ...
  `comment` text,
  PRIMARY KEY (`TypeId`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='OutdoorPvP Templates';
...
/*Table structure for table `personal_rates_table` */

DROP TABLE IF EXISTS `personal_rates_table`;

CREATE TABLE `personal_rates_table` (
  `guid` int(11) DEFAULT NULL,
  `rate_xp` int(11) DEFAULT NULL,
  `rate_honor` int(11) DEFAULT NULL,
  `rate_gold` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `pool_quest` (
  ...
  `description` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`entry`),
  KEY `idx_guid` (`entry`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `quest_poi_points` (
  ...
  KEY `questId_id` (`questId`,`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
/*Table structure for table `quest_template_copy` */
...
CREATE TABLE `reputation_spillover_template` (
  ...
  PRIMARY KEY (`faction`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Reputation spillover reputation gain';

/*Table structure for table `research_loot` */
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Skill Discovery System';
...
CREATE TABLE `skill_extra_item_template` (
  ...
  PRIMARY KEY (`spellId`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Skill Specialization System';
...
/*Table structure for table `spell_forbidden` */
...
/*Table structure for table `zone_skip_update` */
...
/* Procedure structure for procedure `myFunction` */

/*!50003 DROP PROCEDURE IF EXISTS  `myFunction` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `myFunction`()
BEGIN
