...
enum Opcodes
{
    ...
    CMSG_BATTLEFIELD_STATUS = 0x04A2, // client send 0x19B0 before status
    ...
    CMSG_MOVE_SPLINE_DONE = 0x0833,
    CMSG_MOVE_TIME_SKIPPED = 0x0152,
    CMSG_NAME_QUERY = 0x0DB3,
    CMSG_REALM_NAME_QUERY = 0x1899,
    CMSG_NEXT_CINEMATIC_CAMERA = 0x05CC,
    ...
    CMSG_PETITION_BUY = 0x07D6,
    CMSG_PETITION_QUERY = 0x15A2,
    CMSG_PETITION_SHOWLIST = 0x0000,
    CMSG_PETITION_SHOW_SIGNATURES = 0x11FC,
    CMSG_PETITION_SIGN = 0x0555,
    CMSG_PET_ABANDON = 0x05D7,
    CMSG_PET_ACTION = 0x04D4,
    CMSG_PET_CANCEL_AURA = 0x01F5,
    CMSG_PET_CAST_SPELL = 0x00E8,
    CMSG_PET_NAME_QUERY = 0x16A3,
    CMSG_PET_RENAME = 0x133A,
    CMSG_PET_SET_ACTION = 0x07DE,
    CMSG_PET_STOP_ATTACK = 0x07F7,
    CMSG_PING = 0x1070,
    ...
    CMSG_REQUEST_FORCED_REACTIONS = 0x00EB,
    ...
    CMSG_REQUEST_PVP_REWARDS = 0x0C82,
    CMSG_REQUEST_RAID_INFO = 0x1980,
    CMSG_REQUEST_RATED_BG_INFO = 0x1789,
    CMSG_REQUEST_RATED_BG_STATS = 0x0D93,
    ...
    CMSG_SPIRIT_HEALER_ACTIVATE = 0x05D4,
    ...
    CMSG_NOTIFY_PARTY_SQUELCH = 0x0000,
    MSG_QUERY_NEXT_MAIL_TIME = 0x05F7,
    ...
    SMSG_DUEL_COMPLETE = 0x0C8A,
    SMSG_DUEL_COUNTDOWN = 0x0C91,
    SMSG_DUEL_INBOUNDS = 0x0E43,
    SMSG_DUEL_REQUESTED = 0x0C2A,
    SMSG_DUEL_WINNER = 0x064A,
	...
	SMSG_MOVE_UPDATE_COLLISION_HEIGHT = 0x179A, // 5.4.7 18019 - CHECK!
	...
	SMSG_MOVE_UPDATE_SWIM_BACK_SPEED = 0x1388, // 5.4.7 18019
	...
	SMSG_PLAY_ONE_SHOT_ANIM_KIT = 0x1F3B, // 5.4.7 18019 Not implemented - CHECK!
    ...
    SMSG_TURN_IN_PETITION_RESULTS = 0x0509,
	...
	MSG_MOVE_FEATHER_FALL = 0x16D2, // 5.4.7 18019
