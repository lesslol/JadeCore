...
// Essence of Yu'lon - 146198 
class spell_essence_of_yulon : public SpellScriptLoader
{
public:
    spell_essence_of_yulon() : SpellScriptLoader("spell_essence_of_yulon") { }

    class spell_essence_of_yulon_aura_script : public AuraScript
    {
        PrepareAuraScript(spell_essence_of_yulon_aura_script);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_essence_of_yulon_aura_script::HandleDummyTick, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_essence_of_yulon_aura_script();
    }
};

// Essence of Yu'lon - 146197
class spell_essence_of_yulonsecondary : public SpellScriptLoader
{
public:
    spell_essence_of_yulonsecondary() : SpellScriptLoader("spell_essence_of_yulonsecondary") { }
    ...
    class spell_essence_of_yulon_aura_script : public AuraScript
    {
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_essence_of_yulon_aura_script::HandleDummyTick, EFFECT_1, SPELL_AURA_PERIODIC_DUMMY);
        }
    };
...
class spell_pouch_of_timeless_coins : public SpellScriptLoader
{
public:
    spell_pouch_of_timeless_coins() : SpellScriptLoader("spell_pouch_of_timeless_coins") { }

    class spell_pouch_of_timeless_isle_spell_script : public SpellScript
    {
        PrepareSpellScript(spell_pouch_of_timeless_isle_spell_script);
        ...
        void HandleAfterCast()
        {
            if (GetCaster())
            {
                if (GetCaster()->GetTypeId() == TYPEID_PLAYER)
                {
                    ...
                    player->SetCurrency(777, player->GetCurrency(777, true) + 3500, true);
                    player->DestroyItemCount(104014, 1, true);
                }
            }
        }
        ...
        void Register()
        {
            AfterCast += SpellCastFn(spell_pouch_of_timeless_isle_spell_script::HandleAfterCast);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_pouch_of_timeless_isle_spell_script();
    }
};
...
{
    new spell_pouch_of_timeless_coins();
    new spell_essence_of_yulon();
    new spell_essence_of_yulonsecondary();
