...
#define JADECORE_ACCEPTED_CLIENT_BUILD        {18414, 18019, 17898, 17399, 16135, 15595, 12340, 0}  // accept one Mists of Pandaria, one Cataclysm and one Wrath of the Lich King build
